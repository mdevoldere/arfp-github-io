---
layout: default 
title: "Vous n'avez pas besoin de jQuery"
---
...
De reste, John Resig (le papa de jQuery) lui-même s'est détourné de toute activité sur jQuery et consacre sont temps uniquement pour Javascript.
...
Aujourd'hui, il n'y a aucun intérêt pour un développeur de démarrer un projet utilisant du jQuery.
