...
- le terminal (avec nodejs)
- la console du navigateur (scripts intégrés aux pages web)

--- 
Testez le code ci-dessous et analysez les résultats affichés dans la console.
